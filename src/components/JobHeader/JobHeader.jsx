...
const JobHeader = () => {
  ...
  const allTitles = [
    ...
    "Бекенд разработчик",
    "Преподователь по математике",
    "Преподователь по физике",
    "Преподователь по кыргызского языка",
    "Преподователь по русского языка",
    "Преподователь по английского языка",
    "Преподователь по литературе",
    "Преподователь для начальных классов",
  ];
